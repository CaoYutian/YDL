...
+ (NSAttributedString *)attributedStringWithString:(NSString *)string textRange:(NSInteger)textRange {
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:blackColor range:NSMakeRange(rangeTeger, range.location + 1)];
    [attributedString addAttribute:NSForegroundColorAttributeName value:NavigationBarBackgroundColor range:NSMakeRange(range.location, string.length - range.location)];

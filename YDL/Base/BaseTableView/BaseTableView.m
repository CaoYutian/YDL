...
- (void)reLoadDataFromServer {
    ...
    if ([self viewController] && [[self viewController] isKindOfClass:[BaseVC class]]) {
        BaseVC *superVC = (BaseVC *)[self viewController];
        hudSuperView = superVC.contentView;
    } else if (topMostViewController() && [topMostViewController() isKindOfClass:[BaseVC class]]){
        hudSuperView = ((BaseVC *)topMostViewController()).contentView;
    } else {

...
- (void)setItem:(MMItem *)item {
    ...
    for (int i = 0; i < item.childrenNodes.count; i ++) {
        ...
        [button setTitleColor:subItem.isSelected ? whiteColor : blackColor forState:UIControlStateNormal];
        button.backgroundColor = subItem.isSelected?[UIColor colorWithHexString:titleSelectedColor]:whiteColor;
